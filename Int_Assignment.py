...
b = 255
print(id(a))
print(id(b)) # id of a and b will be same because 0 - 256 is object reusability in python.
...
b = -6
print(id(a))
print(id(b)) # id of a and b will be different because 0 - 256 only is object reusability in python.
